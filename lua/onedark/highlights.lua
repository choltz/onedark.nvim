...
local colors = {
    ...
    LightestGrey = {fg = c.lightest_grey},
    Grey = {fg = c.grey},
    Red = {fg = c.red},
    Cyan = {fg = c.cyan},
    Yellow = {fg = c.yellow},
    ...
    Green = {fg = c.green},
    Blue = {fg = c.blue},
    LightestBlue = {fg = c.lightest_blue},
    Purple = {fg = c.purple}
}
hl.common = {
...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        -- ["@function.method"] = {fg = c.lightest_grey, fmt = cfg.code_style.functions},
        ["@function.method"] = {fg = c.light_yellow, fmt = cfg.code_style.functions},

        ["@function.call"] = {fg = c.lightest_grey, fmt = cfg.code_style.functions},
        ...
        ["@keyword.operator"] =  {fg = c.light_yellow, fmt = cfg.code_style.keywords},
        ["@keyword.repeat"] = {fg = c.purple, fmt = cfg.code_style.keywords},
        ["@keyword.sql"] = {fg = c.blue, fmt = cfg.code_style.keywords},
        ["@label"] = colors.Red,
        ...
        ["@number.scss"] = colors.LightYellow,
        ["@operator"] = colors.Fg,
        ...
        ["@string.scss"] = colors.LightYellow,
        ["@string.regexp"] = {fg = c.orange, fmt = cfg.code_style.strings},
        ["@string.escape"] = {fg = c.red, fmt = cfg.code_style.strings},
        ["@string.html"] = {fg = c.orange, fmt = cfg.code_style.strings},
        -- ["@string.special.symbol"] = colors.Cyan,
        ["@string.special.symbol"] = colors.Blue,
        -- ["@tag"] = colors.Purple,
        ["@tag"] = colors.Blue,
        ["@tag.scss"] = colors.Yellow,
        ["@property.scss"] = colors.LightestBlue,
        -- ["@tag.attribute"] = colors.Yellow,
        ["@tag.attribute"] = colors.LightestBlue,
        ["@tag.attribute.html"] = colors.Purple,
        ...
        ["@method.declaration"] = {fg = c.light_yellow, fmt = cfg.code_style.functions},
    ...
    if vim.api.nvim_call_function("has", { "nvim-0.9" }) == 1 then
        hl.lsp = {
            ...
            ["@lsp.typemod.method.declaration"] = hl.treesitter["@method.declaration"],
